...
# Input server name, port, and user
# read -p "Enter Server Name for FTP: " server_name
# read -p "Enter Port for FTP: " port
read -p "Enter FTP User: " ftp_user
# read -p "Enter Password for $ftp_user: " -s ftp_password
